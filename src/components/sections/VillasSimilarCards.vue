<template lang="pug">
    ...
    +b.SECTION.villas-cards--white
        +e.container.container
            +e.text.description
                h3 Похожие предложения
                p Мы стараемся не просто подчеркнуть все преищества этого региона, но и дополнить их высокими стандартами обслуживания и качества недвижимости, характерными для более дорогих курортов.
            +e.toggles.toggles__(
                ref="toggles"
            )
                +e.item(
